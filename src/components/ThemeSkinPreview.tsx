...
export const THEME_SCREENSHOTS: Partial<Record<string, number>> = {
  solid_blue:      require('../../assets/theme/blue/blue1.png'),
  solid_gray:      require('../../assets/theme/gray/gray1.png'),
  solid_green:     require('../../assets/theme/green/green1.png'),
  solid_pink:      require('../../assets/theme/pink/pink1.png'),
  solid_purple:    require('../../assets/theme/purple/purple1.png'),
  solid_sky:       require('../../assets/theme/skyblue/skyblue1.png'),
  solid_mint:      require('../../assets/theme/mint/mint1.png'),
  solid_red:       require('../../assets/theme/red/red1.png'),
  solid_orange:    require('../../assets/theme/orange/orange1.png'),
  solid_yellow:    require('../../assets/theme/yellow/yellow1.png'),
  solid_beige:     require('../../assets/theme/beige/beige1.png'),
  solid_teal:      require('../../assets/theme/teal/teal1.png'),
  skin_deep_sea:   require('../../assets/theme/deepsea/deepsea1.png'),
  skin_leaf_blur:  require('../../assets/theme/greennature/greennature1.png'),
  skin_sakura:     require('../../assets/theme/sakura/sakura1.png'),
  skin_snow:       require('../../assets/theme/snowmountain/snowmountain1.png'),
  shop_roses:      require('../../assets/theme/roses/roses1.png'),
  skin_paw:        require('../../assets/theme/animals/animals1.png'),
  skin_night_city: require('../../assets/theme/nightcity/nightcity1.png'),
  skin_sunset:     require('../../assets/theme/sunset/sunset1.png'),
};
...
export const THEME_SCREENSHOTS_TEST: Partial<Record<string, number>> = {
  solid_blue:      require('../../assets/theme/blue/blue2.png'),
  solid_gray:      require('../../assets/theme/gray/gray2.png'),
  solid_green:     require('../../assets/theme/green/green2.png'),
  solid_pink:      require('../../assets/theme/pink/pink2.png'),
  solid_purple:    require('../../assets/theme/purple/purple2.png'),
  solid_sky:       require('../../assets/theme/skyblue/skyblue2.png'),
  solid_mint:      require('../../assets/theme/mint/mint2.png'),
  solid_red:       require('../../assets/theme/red/red2.png'),
  solid_orange:    require('../../assets/theme/orange/orange2.png'),
  solid_yellow:    require('../../assets/theme/yellow/yellow2.png'),
  solid_beige:     require('../../assets/theme/beige/beige2.png'),
  solid_teal:      require('../../assets/theme/teal/teal2.png'),
  skin_leaf_blur:  require('../../assets/theme/greennature/greennature2.png'),
  skin_sakura:     require('../../assets/theme/sakura/sakura2.png'),
  skin_snow:       require('../../assets/theme/snowmountain/snowmountain2.png'),
  shop_roses:      require('../../assets/theme/roses/roses2.png'),
  skin_paw:        require('../../assets/theme/animals/animals2.png'),
  skin_night_city: require('../../assets/theme/nightcity/nightcity2.png'),
  skin_sunset:     require('../../assets/theme/sunset/sunset2.png'),
};
...
export const THEME_VIDEOS: Partial<Record<string, number>> = {
  skin_deep_sea:  require('../../assets/theme/deepsea/deepsea1.mov'),
  skin_galaxy:    require('../../assets/theme/galaxy/galaxy1.mov'),
  skin_aurora:    require('../../assets/theme/aurora/aurora1.mov'),
  skin_cyber:     require('../../assets/theme/cyberneon/cyberneon1.mov'),
  shop_woods:     require('../../assets/theme/beautifulwoods/beautifulwoods1.mov'),
  skin_rain:      require('../../assets/theme/rainywindow/rainywindow1.mov'),
};
...
export const THEME_VIDEO_POSTERS: Partial<Record<string, number>> = {
  skin_deep_sea:  require('../../assets/theme/deepsea/deepsea1.png'),
  skin_galaxy:    require('../../assets/theme/galaxy/galaxy1.png'),
  skin_aurora:    require('../../assets/theme/aurora/aurora1.png'),
  skin_cyber:     require('../../assets/theme/cyberneon/cyberneon1.png'),
  shop_woods:     require('../../assets/theme/beautifulwoods/beautifulwoods1.png'),
  skin_rain:      require('../../assets/theme/rainywindow/rainywindow1.png'),
};
...
export const THEME_VIDEOS_TEST: Partial<Record<string, number>> = {
  skin_deep_sea:  require('../../assets/theme/deepsea/deepsea2.mov'),
  skin_galaxy:    require('../../assets/theme/galaxy/galaxy2.mov'),
  skin_aurora:    require('../../assets/theme/aurora/aurora2.mov'),
  skin_cyber:     require('../../assets/theme/cyberneon/cyberneon2.mov'),
  shop_woods:     require('../../assets/theme/beautifulwoods/beautifulwoods2.mov'),
  skin_rain:      require('../../assets/theme/rainywindow/rainywindow2.mov'),
};
