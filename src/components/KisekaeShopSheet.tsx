...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  // ── Popular tab — non-free solids (¥120) interleaved with premium image skins ─
  { id: 'skin_deep_sea',   name: 'Deep Sea',       price: 480, category: 'premium', previewBg: '#061628', previewAccent: '#38BDF8', previewEmoji: '🌊', tags: ['dark_bg','ocean'] },
  { id: 'solid_sky',       name: 'Sky Blue',        price: 120, category: 'solid',   previewBg: '#E0F2FE', previewAccent: '#0EA5E9', previewEmoji: '🩵', tags: ['minimal','bright','colorful'] },
  { id: 'skin_galaxy',     name: 'Galaxy',          price: 480, category: 'premium', previewBg: '#050714', previewAccent: '#818CF8', previewEmoji: '🌌', tags: ['dark_bg','space'] },
  { id: 'solid_purple',    name: 'Purple',          price: 120, category: 'solid',   previewBg: '#F5F0FF', previewAccent: '#7C3AED', previewEmoji: '💜', tags: ['minimal','colorful'] },
  { id: 'skin_aurora',     name: 'Aurora',          price: 480, category: 'premium', previewBg: '#020814', previewAccent: '#00E5A0', previewEmoji: '🌠', tags: ['dark_bg','aurora'] },
  { id: 'solid_green',     name: 'Green',           price: 120, category: 'solid',   previewBg: '#EDFBF2', previewAccent: '#16A34A', previewEmoji: '💚', tags: ['minimal','bright','nature'] },
  { id: 'skin_cyber',      name: 'Cyber Neon',      price: 480, category: 'premium', previewBg: '#040810', previewAccent: '#00E5FF', previewEmoji: '⚡', tags: ['dark_bg','neon'] },
  { id: 'solid_pink',      name: 'Pink',            price: 120, category: 'solid',   previewBg: '#FCE7F3', previewAccent: '#EC4899', previewEmoji: '🩷', tags: ['minimal','bright','colorful'] },
  { id: 'skin_leaf_blur',  name: 'Green Nature',    price: 320, category: 'premium', previewBg: '#2D4A2D', previewAccent: '#2E7D5A', previewEmoji: '🌿', tags: ['wallpaper','blur','nature','cozy'] },
  { id: 'solid_mint',      name: 'Mint',            price: 120, category: 'solid',   previewBg: '#DCFCE7', previewAccent: '#10B981', previewEmoji: '🌱', tags: ['minimal','bright','nature'] },
  { id: 'shop_woods',      name: 'Beautiful Woods', price: 320, category: 'premium', previewBg: '#1A2E1A', previewAccent: '#6AAF5A', previewEmoji: '🌲', tags: ['dark_bg','nature','cozy'] },
  { id: 'solid_red',       name: 'Red',             price: 120, category: 'solid',   previewBg: '#FEE2E2', previewAccent: '#EF4444', previewEmoji: '❤️', tags: ['minimal','colorful'] },
  { id: 'skin_sakura',     name: 'Sakura',          price: 320, category: 'premium', previewBg: '#FDF4F8', previewAccent: '#F472B6', previewEmoji: '🌸', tags: ['wallpaper','blur','floral','seasonal','bright'] },
  { id: 'solid_orange',    name: 'Orange',          price: 120, category: 'solid',   previewBg: '#FFEDD5', previewAccent: '#F97316', previewEmoji: '🧡', tags: ['minimal','bright','colorful'] },
  { id: 'skin_rain',       name: 'Rainy Window',    price: 320, category: 'premium', previewBg: '#0D1520', previewAccent: '#60A5FA', previewEmoji: '🌧️', tags: ['dark_bg','rain','cozy'] },
  { id: 'solid_yellow',    name: 'Yellow',          price: 120, category: 'solid',   previewBg: '#FEF9C3', previewAccent: '#CA8A04', previewEmoji: '💛', tags: ['minimal','bright','colorful'] },
  { id: 'skin_snow',       name: 'Snow Mountain',   price: 320, category: 'premium', previewBg: '#F0F6FF', previewAccent: '#60A5FA', previewEmoji: '🏔️', tags: ['wallpaper','blur','seasonal','bright'] },
  { id: 'solid_beige',     name: 'Beige',           price: 120, category: 'solid',   previewBg: '#FAF5EB', previewAccent: '#92400E', previewEmoji: '🤎', tags: ['minimal','neutral','cozy'] },
  { id: 'shop_roses',      name: 'Roses',           price: 320, category: 'premium', previewBg: '#FEF0F5', previewAccent: '#D4627A', previewEmoji: '🌹', tags: ['wallpaper','blur','floral','bright'] },
  { id: 'solid_teal',      name: 'Teal',            price: 120, category: 'solid',   previewBg: '#F0FDFA', previewAccent: '#0D9488', previewEmoji: '💎', tags: ['minimal','bright','colorful'] },
  { id: 'skin_coffee',     name: 'Coffee House',    price: 320, category: 'premium', previewBg: '#FBF6F0', previewAccent: '#92400E', previewEmoji: '☕', tags: ['wallpaper','blur','cozy','bright'] },
  { id: 'skin_paw',        name: 'Animal',          price: 320, category: 'premium', previewBg: '#FFF8F0', previewAccent: '#BF7A40', previewEmoji: '🐾', tags: ['wallpaper','blur','cozy','bright'] },
  { id: 'skin_night_city', name: 'Night City',      price: 480, category: 'premium', previewBg: '#0A0816', previewAccent: '#F59E0B', previewEmoji: '🌃', tags: ['dark_bg','city','neon'] },
  { id: 'skin_sunset',     name: 'Sunset',          price: 320, category: 'premium', previewBg: '#FFF3E8', previewAccent: '#F97316', previewEmoji: '🌅', tags: ['wallpaper','blur','bright','colorful'] },
];
    ...
    <TouchableOpacity style={[styles.card, { width: CARD_W }]} onPress={onPress} activeOpacity={0.8}>
      ...
      >
        {item.category === 'premium' ? (
          <PremiumSkinPreview item={item} skinData={skinData} width={CARD_W} height={THUMB_H} />
        ) : (
          <>
            ...
            <View style={[StyleSheet.absoluteFill, styles.wordPingCenter]}>
              <Text style={[styles.cardWordPing, { color: item.previewAccent }]}>WordMemo</Text>
            </View>
          </>
        )}
        {isSelected && (
...
export function KisekaeShopSheet({
  ...
  useEffect(() => {
    if (visible) {
      // Always open on the Popular tab — never remember the previously selected tab.
  ...
  return (
    ...
    >
      ...
      <ThemeDetailsSheet
        ...
        themeColor={themeColor}
        onApply={handleTap}
        onUpgrade={() => { setDetailsItem(null); onUpgrade?.(); }}
      />
    </Animated.View>
  );
}
