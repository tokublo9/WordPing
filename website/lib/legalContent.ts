    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'What the WordCore API Worker additionally receives: a randomly generated installation identifier stored in your device’s Keychain, and your pseudonymous RevenueCat App User ID. They are used to verify your subscription tier and to apply abuse-prevention and usage limits. They are not forwarded to OpenAI.',
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'WordCore API Workerが追加で受け取る情報：端末のキーチェーンに保存されたランダムなインストール識別子、および仮名化されたRevenueCat App User ID。サブスクリプション区分の確認、不正利用防止および利用上限の適用に使用され、OpenAIへ転送されることはありません。',
